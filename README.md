...
├── src/components/billing/   # 14 个 React 组件 + 类型 + 数据
...
```tsx
import { QuotaCard, PackageCard, PayCard, /* ... */ } from '@/components/billing'
import { demoQuotas, demoPackages, demoPaymentOrder } from '@/components/billing/data'
```
