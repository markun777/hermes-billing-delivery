  ...
  return (
    ...
    >
      ...
      <div className="flex w-full items-start overflow-hidden">
        ...
        <div className="flex w-[88px] shrink-0 self-stretch">
          {canInvoice ? (
            <button
              className="flex w-full items-center justify-center rounded-[2px] border border-[rgba(188,205,232,0.56)] bg-[#f8fafc] px-4 py-2 text-[14px] font-normal whitespace-nowrap text-[#475569] hover:bg-[#f1f5f9]"
